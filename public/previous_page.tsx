...
/* ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
   REVEAL WRAPPER ΓÇö appears on scroll
   ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
function Reveal({
    children,
    delay = 0,
...
/* ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
   PROGRESSIVE TEXT ΓÇö reveals letter by letter
   ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
...
/* ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
   BLUR FRAGMENT ΓÇö reveals through scroll
   ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
                    ...
                    <div className="act__inner">
                        ...
                        <Reveal delay={0.2}>
                            <div className="ethereal__definition">
                                ...
                                <p className="ethereal__phonetic">/╔¬╦ê╬╕╔¬╔Öri╔Öl/</p>
                    ...
                    <div className="act__inner">
                        ...
                        <Reveal delay={0.2}>
                            ...
                            <p className="body-text" style={{ marginBottom: "60px" }}>
                                <em>/╔¬n╦ê╔¢f╔Öb(╔Ö)l/</em>, too great or extreme to be expressed in words.
                            </p>
                        </Reveal>
                ...
                <section className="act act--serendipity" id="act-serendipity">
                    <div className="act__inner">
                        ...
                        <Reveal delay={0.2}>
                            ...
                            <p className="body-text" style={{ marginBottom: "60px" }}>
                                <em>/╦îs╔¢r.╔Ön╦êd╔¬p.╔¬.ti/</em>. The occurrence of events by chance in a happy way.
                            </p>
                        </Reveal>
                ...
                <section className="act act--radiance" id="act-radiance">
                    ...
                    <div className="act__inner">
                        ...
                        <Reveal delay={0.2}>
                            ...
                            <p className="body-text" style={{ marginBottom: "60px" }}>
                                <em>/╦êre╔¬.di.╔Öns/</em>. Light or heat as emitted or reflected; warm joy.
                            </p>
                        </Reveal>
